...
object Urls {
    ...
    const val BASE_URL = "https://jumbotail.herokuapp.com"
    const val SIGN_IN = "/auth/signin/"
    const val SIGN_UP = "/auth/signup/"
    const val NOTIFICATION_LIST = "/api/asset/notification/"
    const val ASSET_NOTIFICATION_LIST = "/api/asset/notification/{id}"
